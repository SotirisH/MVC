...
namespace Aurora.SMS.FakeProvider.Controllers
{
    ...
    /// </remarks>
    public class FlashSmsController : ApiController
    {
        ...
        public virtual void DecreaseCredit()
        {
            ...
            System.Web.HttpContext.Current.Application["CreditsFlashSms"] = (int)(System.Web.HttpContext.Current.Application["Credits"]) - 1;
                 ...
                 string password)
        {
            ApplyDelay();
            // Remove one credit from the application variable
            return (int)(System.Web.HttpContext.Current.Application["CreditsFlashSms"]);
        }
    }
